...
use colored::*;
use gateway_core::modules::{cursor_account, gemini_account, github_copilot_account};
use tabled::{Table, Tabled};

#[derive(Parser)]
#[command(author, version, about = "Gateway-tools CLI", long_about = None)]
struct Cli {
    #[command(subcommand)]
...
async fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        None => {
            println!("Welcome to Gateway CLI! Use --help for commands.");
        }
    }
